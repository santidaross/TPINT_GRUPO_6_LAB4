 ...
 */
@WebServlet(description = "Servlet para el cierre de sesion de usuarios", urlPatterns = { "/logout" })
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//} else {
				...
				boolean checkbox_recordar = "true".equals(request.getParameter("checkbox_recordarusuario"));
