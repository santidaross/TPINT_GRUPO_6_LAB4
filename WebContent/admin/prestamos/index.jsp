...
<body>
	<div class="contenedor">
		...
		<div class="main">
			<div class="header">
				<h1>Prestamos a Aprobar</h1>
				<h2><a href="${pageContext.request.contextPath}/admin/prestamos/historial.jsp">Historial de prestamos</a></h2>
			</div>
		<div class="contenido">
			<div id="table" style= "width: 100%;margin: auto; overflow:auto;">
				<table id="tablaClientes" class="pure-table"
					...
					<tr class="pure-table-odd">
						<th id="columna_aceptar">Aceptar</th>
						<th id="columna_rechazar">Rechazar</th>
						<th>DNI</th>
						<th>Nombre</th>
						<th>Apellido</th>
						<th>Fecha</th>
